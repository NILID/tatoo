...
# update profiles
angel.profile.update!(price: 500,  active: true, color: 'black', tatoo_size: 5,  work_type: 'rotary')
ivans.profile.update!(price: 2500, active: true,                 tatoo_size: 10, work_type: 'induction')
aleks.profile.update!(price: 8000, active: true,                 tatoo_size: 50, work_type: 'rotary')
elena.profile.update!(price: 500,  active: true, color: 'black', tatoo_size: 5,  work_type: 'handwork')
